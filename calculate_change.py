...
def calculate_change():
    ...
    # take price as input
    item_price = float(input("How much £ is owed? "))

    # take payment amount as input
    payment_received = float(input("How much £ has been paid? "))

    # calculate difference
    change_due = round(payment_received - item_price, 2)
    ...
    # loop through each denomination and calculate multiples
